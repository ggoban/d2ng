...
export class GameEventManager {
  ...
  setupEventListeners() {
    ...
    this.addListener("blacksmithButton", "click", () =>
      this.game.goToBlacksmith()
    );
    this.addListener("dungeonButton", "click", () => this.game.goToDungeon());
    this.addListener("exploreButton", "click", () => this.game.explore());
    this.addListener("nextFloorButton", "click", () =>
      this.game.goToNextFloor()
    );
    this.addListener("returnTownButton", "click", () =>
